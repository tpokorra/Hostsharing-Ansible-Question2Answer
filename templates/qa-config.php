...
*/
	...
	define('QA_MYSQL_USERNAME', '{{pac}}_{{user}}');
	define('QA_MYSQL_PASSWORD', '{{password}}');
	define('QA_MYSQL_DATABASE', '{{pac}}_{{user}}');
...
*/
define('QA_BLOBS_DIRECTORY', '/home/pacs/{{pac}}/users/{{user}}/data');
...
*/
define('QA_CACHE_DIRECTORY', '/home/pacs/{{pac}}/users/{{user}}/cache');
...
*/
define('QA_COOKIE_DOMAIN', '.{{domain}}');
